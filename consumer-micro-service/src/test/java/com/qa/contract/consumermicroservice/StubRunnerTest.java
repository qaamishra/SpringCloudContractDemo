...
@SpringBootTest(classes = ConsumerMicroServiceApplication.class, webEnvironment = SpringBootTest.WebEnvironment.MOCK)
@AutoConfigureMockMvc
@AutoConfigureJsonTesters
@AutoConfigureStubRunner(stubsMode = StubRunnerProperties.StubsMode.LOCAL,
        ids = "com.qa.contract:provider-micro-service:+:stubs:8091")
//groupId:artifactId:version(+ means latest version):stubs:8091
